...
import type { TokenUsageSummary, TraceEntry } from '@tokens-as-parameters/core-optimization'

export type { TokenUsageSummary, TraceEntry } from '@tokens-as-parameters/core-optimization'
...
export function sessionTraceTail(events: readonly SessionEvent[], limit = 24): TraceEntry[] {
